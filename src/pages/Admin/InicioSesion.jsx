        ...
        <div className= 'flex w-full flex-col items-center  py-4'>
            ...
            <form className='mt-8 max-md'>
              ...
              <a href='/' className='font-medium text-blue-700 hover:text-blue-400'>
                ...
                <button
              type='submit'
              className='group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-900 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
            >
